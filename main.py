...
class UserStore(Base):
    ...
    industry_name = Column(String(100), nullable=True)  # DDL에서 nullable=True
...
class DistrictIndustryMix(Base):
    """
    상권별 업종 분포 데이터
    DDL: district_industry_mix - DDL과 100% 일치
    """
